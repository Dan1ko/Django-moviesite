...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField('Budget', default=0,
                                         help_text='indicate the amount in US dollars')
    fees_in_usa = models.PositiveIntegerField(
        'Box office in the USA', default=0, help_text='indicate the amount in US dollars'
    )
    fees_in_world = models.PositiveIntegerField(
        'Box office worldwide', default=0, help_text='indicate the amount in US dollars'
    )
