...
class MovieAdminForm(forms.ModelForm):
    description_en = forms.CharField(label='Info', widget=CKEditorUploadingWidget())
    description_ru = forms.CharField(label='Info', widget=CKEditorUploadingWidget())
...
admin.site.site_title = 'Dan1ko Movies'
admin.site.site_header = 'Dan1ko Movies'
